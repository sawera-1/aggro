    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15, paddingTop: 15, paddingBottom: 10 }}>
          ...
          {/* Title */}
          <Text style={{ fontSize: 22, fontWeight: 'bold', color: '#031501ff' }}> {t('updates.title')}</Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginBottom: 10, marginTop: 10 }}>
          <TouchableOpacity onPress={() => setSelectedTab('GovtSchemes')} style={{ paddingBottom: 5, borderBottomWidth: selectedTab === 'GovtSchemes' ? 2 : 0, borderBottomColor: '#006644' }}>
            <Text style={{ color: selectedTab === 'GovtSchemes' ? '#006644' : '#031501ff', fontWeight: selectedTab === 'GovtSchemes' ? 'bold' : 'normal' }}>{t('updates.tabs.govt')}</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => setSelectedTab('MarketPrices')} style={{ paddingBottom: 5, borderBottomWidth: selectedTab === 'MarketPrices' ? 2 : 0, borderBottomColor: '#006644' }}>
            <Text style={{ color: selectedTab === 'MarketPrices' ? '#006644' : '#031501ff', fontWeight: selectedTab === 'MarketPrices' ? 'bold' : 'normal' }}>{t('updates.tabs.market')}</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => setSelectedTab('CropInfo')} style={{ paddingBottom: 5, borderBottomWidth: selectedTab === 'CropInfo' ? 2 : 0, borderBottomColor: '#006644' }}>
            <Text style={{ color: selectedTab === 'CropInfo' ? '#006644' : '#031501ff', fontWeight: selectedTab === 'CropInfo' ? 'bold' : 'normal' }}>{t('updates.tabs.crop')}</Text>
          </TouchableOpacity>
        </View>
            ...
            <>
              <View style={{ flexDirection: 'row', borderWidth: 1, borderColor: '#006644', borderRadius: 10, padding: 10, marginBottom: 10, backgroundColor: '#e9e9e1' }}>
                ...
                <View style={{ flex: 1, justifyContent: 'space-between' }}>
                  <Text style={{ color: '#006644', fontWeight: 'bold', fontSize: 16 }}>{t('updates.schemes.subsidyTitle')}</Text>
                  <Text style={{ color: '#888', fontSize: 12, marginVertical: 5 }}>2025-08-13</Text>
                  <TouchableOpacity onPress={() => navigation.navigate('GovtRead')} style={{ flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', backgroundColor: '#006644', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 20 }}>
           <Text style={{ color: '#fff', marginRight: 5 }}>{t('updates.readMore')}</Text>
          ...
          {selectedTab === 'MarketPrices' && (
            <>
              <View style={{ flexDirection: 'row', borderWidth: 1, borderColor: '#006644', borderRadius: 10, padding: 10, marginBottom: 10, backgroundColor: '#e9e9e1' }}>
                ...
                <View style={{ flex: 1, justifyContent: 'space-between' }}>
                  <Text style={{ color: '#006644', fontWeight: 'bold', fontSize: 16 }}>{t('updates.market.marketTitle')}</Text>
                  <Text style={{ color: '#888', fontSize: 12, marginVertical: 5 }}>2025-08-14</Text>
                  <TouchableOpacity onPress={() => navigation.navigate('PriceRead')} style={{ flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', backgroundColor: '#006644', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 20 }}>
                    <Text style={{ color: '#fff', marginRight: 5 }}>{t('updates.readMore')}</Text>
          ...
          {selectedTab === 'CropInfo' && (
            <>
              <View style={{ flexDirection: 'row', borderWidth: 1, borderColor: '#006644', borderRadius: 10, padding: 10, marginBottom: 10, backgroundColor: '#e9e9e1' }}>
                ...
                <View style={{ flex: 1, justifyContent: 'space-between' }}>
                  <Text style={{ color: '#006644', fontWeight: 'bold', fontSize: 16 }}> {t('updates.crop.cropTitle')}</Text>
                  <Text style={{ color: '#888', fontSize: 12, marginVertical: 5 }}>2025-08-12</Text>
                  <TouchableOpacity onPress={() => navigation.navigate('CropRead')} style={{ flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', backgroundColor: '#006644', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 20 }}>
                   <Text style={{ color: '#fff', marginRight: 5 }}>{t('updates.readMore')}</Text>
