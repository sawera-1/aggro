      ...
      >
        ...
        <ScrollView contentContainerStyle={{ padding: 20, alignItems: 'center' }}>
          ...
          <Text style={{ fontSize: 15, color: '#444', marginBottom: 6 }}>
            {t("expertchannelDes.totalMembers")}: {members || '10'}
          </Text>
          <Text style={{ fontSize: 15, color: '#444', marginBottom: 18 }}>
            {t("expertchannelDes.dateCreated")}: {dateCreated || '01 Jan 2025'}
          </Text>

          {/* Description */}
          <Text style={{ fontSize: 15, color: '#555', textAlign: 'center', marginBottom: 35, paddingHorizontal: 15 }}>
            {channelDescription || t("expertchannelDes.noDescription")}
          </Text>
          ...
          >
            ...
            <Text style={{ color: '#fff', fontSize: 16, fontWeight: '600' }}>{t("expertchannelDes.exitGroup")}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={{ color: '#fff', fontSize: 16, fontWeight: '600' }}>{t("expertchannelDes.reportGroup")}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={{ color: '#fff', fontSize: 16, fontWeight: '600' }}>{t("expertchannelDes.chatWithExpert")}</Text>
          </TouchableOpacity>
        </ScrollView>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {t("expertchannelDes.exitConfirmation")}
              </Text>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                ...
                >
                  ...
                  <Text style={{ color: '#fff', fontSize: 15, fontWeight: '600' }}>{t("expertchannelDes.cancel")}</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={{ color: '#fff', fontSize: 15, fontWeight: '600' }}>{t("expertchannelDes.exit")}</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
