...
const OwnChannelMsgScreen = ({ navigation }) => {
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('OwnChannelDescription', {
                channelName: name,
                channelImage: image,
        ...
        >
          ...
          <TextInput
            placeholder={t('ownchannelMsg.typeMessage')}
            style={{
              flex: 1,
...
export default OwnChannelMsgScreen;
